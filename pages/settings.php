...
<div id="content">
    ...
    <form action="" method="POST">
        <table id="tbl" align="center" width="400">
            <tr>
                <td width="40%"><?php echo $lang['realname']; ?>:</td><td width="60%"><input type="text" name="realname" size="33" value="<?php echo $sbnc->Call("getvalue", array("realname")); ?>" <?php echo getLockSetting("realname"); ?>/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="40%"><?php echo $lang['password']; ?>:</td><td width="60%"><input type="text" name="password" size="33" <?php echo getLockSetting("password"); ?>/></td>
            </tr>
            <tr>
