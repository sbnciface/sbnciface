...
<?php
/*
 * German language file by BlueaKaKev.
*/
?>
<?php
$lang = array(
        ...
        "on"                    =>  "an",
        "off"                   =>  "aus",
        "save_changes"          =>  "Einstellungen speichern",
        "join_channel"          =>  "Channel betreten.",
        "channel"               =>  "Channel",
        "join"                  =>  "betreten",
        "modes"                 =>  "Modes",
        "action"                =>  "Aktionen",
        ...
        "global_msg"            =>  "Globale Nachricht",
        "logout"                =>  "ausloggen",
        "username"              =>  "Benutzername",
        "login"                 =>  "einloggen",
        "remember_me"           =>  "Dauerhaft angemeldet bleiben",
        //process.php
        "joined"                =>  "betrete",
        "parted"                =>  "verlasse",
