...
<?php
/*
 * Danish language file by: Arne "DarkDeviL" Jensen <darkdevil@darkdevil.dk>.
*/
?>
<?php
$lang = array(
        ...
        "server"                =>  "Server",
        "port"                  =>  "Port",
        "server_password"       =>  "Server adgangskode",
        "vhost"                 =>  "vHost",
        "vhosts"                =>  "vHosts",
        ...
        "log"                   =>  "Log",
        "admin"                 =>  "Admin",
        "trusted_ips"           =>  "Godkendte IP adresser",
        "global_msg"            =>  "Global besked",
        "logout"                =>  "Log ud",
        "username"              =>  "Brugernavn",
        "login"                 =>  "Login",
