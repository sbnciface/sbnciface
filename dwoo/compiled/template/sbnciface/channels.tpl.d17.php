...
?><tr><form action="" method="post"><input type="hidden" name="channel" value="<?php echo $this->scope["channel"]["channel"];?>" /><td><?php echo $this->scope["channel"]["channel"];?></td><td><?php echo $this->scope["channel"]["chanmodes"];?></td><td align="center"><input class="input-image" type="image" src="template/sbnciface/img/icons/delete.png"  value="<?php echo $this->readVarInto(array (  1 =>   array (    0 => '.',  ),  2 =>   array (    0 => 'submitPartValue',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->readParentVar(1), false);?>" name="part" /></td></form></tr>
                        <?php 
/* -- foreach end output */
	}
}?>
